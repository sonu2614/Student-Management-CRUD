...
function addStudent() {
    ...
    const degreeS = document.getElementById('degree').value;

    //Inputs Mandatory, Blank will not be submitted.
    if (nameS == '' || emailS == '' || ageS == '' || gradeS == '' || degreeS == "") {
    ...
    students.push({
        ID: count, name: nameS, email: emailS, age: ageS, grade: gradeS, degree: degreeS
    });
